...
/* Modified for projects 17.1, 17.2: compare with inventory.c.orig */
...
size_t num_parts = 0, allocated_parts = 0;   /* number of parts currently stored */
...
static int invcmp(const void *a, const void *b) {
  int anum = ((struct part *)a)->number, bnum = ((struct part *)b)->number;
